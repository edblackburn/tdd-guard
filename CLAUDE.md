...
├── dotnet/                       # TddGuard.Dotnet - .NET reporter (NuGet)
...
- **reporters/**: Language-specific test reporters (dotnet, go, jest, minitest, phpunit, pytest, rspec, rust, storybook, vitest)
